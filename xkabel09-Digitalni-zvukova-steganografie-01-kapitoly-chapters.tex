...
vodoznaku neoprávněnou osobou \cite{Gruhl1996}.
...
na stejný počet segmentů jako při kódování. Poté se vypočítá jeho cepstrum,
...
segmentu logická~1 \cite{Gruhl1996}. Příklad cepstra segmentu včetně špiček
na indexech zpoždění lze vidět na obrázku \ref{pic:segment-cepstrum}.
...
\subsection*{Další modifikace metody skrývání pomocí ozvěny}
\label{sub:echo-modifications}

\todo{popis modifikací echo metody}
