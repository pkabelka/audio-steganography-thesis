...
zadaných datových sadách a~také program pro zpracování těchto dat.
...
robustnosti a~nepostřehnutelnosti. Mezi tyto techniky patří Huffmanovo kódování
a~jiné kompresní algoritmy, šifrování, paritní a~samoopravné kódy. Dalším
vylepšením do budoucna by mohla být možnost tyto techniky kombinovat stylem
vrstvení.
