...
vynásoben pseudonáhodnou sekvencí hodnot \textit{-1} a~\textit{1} $n$-krát.
Tím dojde k~rozprostření informačních bitů přes více přenesených bitů.
Zvýšení počtu kopií bitů zvýší robustnost a~zároveň sníží kapacitu této metody
