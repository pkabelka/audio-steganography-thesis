...
hodnot. Toho docílíme vzorkováním signálu na určité vzorkovací frekvenci
a~kvantováním \cite{Cernocky2021}.
...
přítomnost pulzu~(1) a~nepřítomnost pulzu~(0). Tomuto systému, který obsahuje
vzorkování, kvantování a~kódování, se říká \textit{pulzně-kódová
modulace}~(PCM) \cite{Oliver1948}.
