...
Pro zvýšení robustnosti a~nepostřehnutelnosti použili autoři \cite{Oh2001}
...
O~2~roky později publikovali autoři \cite{Kim2003} způsob jak znovu zvýšit
robustnost pomocí konvolučního jádra se dvěma ozvěnami posunutými vpřed i~vzad
(anglicky backward-forward echo).
