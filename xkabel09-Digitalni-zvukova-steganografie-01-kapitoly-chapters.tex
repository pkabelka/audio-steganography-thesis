...
informace určena. Steganografii dnes dělíme na tradiční a~digitální.
V~digitální steganografii je velké množství typů dat do kterých můžeme vkládat
informace, které chceme utajit a~digitální zvuk je jedním z~nich.
...
mezi vojenskou rozvědkou nebo bezpečnostními složkami~\cite{Dutta2020}. Dalším
často používaným pojmem spojeným se steganografií je vodoznak. Vodoznaky se
používají pro vložení informací o~původu, vlastnictví, či autorských právech
dat \cite{Anderson1998}\cite{Djebbar2012}\cite{Dutta2020}. Velice známým
příkladem jsou žluté tečky -- známé také jako \textit{yellow dots} -- které
inkoustové tiskárny tisknou na každý list. Tyto tečky obsahují zakódované
sériové číslo tiskárny a~čas tisku \cite{Dutta2020}.
