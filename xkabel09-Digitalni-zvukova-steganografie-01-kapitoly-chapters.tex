...
Pro lepší přehled výsledných hodnot nemodifikovaných stego signálů z~automatického a~ručního testování
obsahuje tabulka~\ref{tab:results-summary} výsledné hodnoty SNR, PSNR
a~kapacitu metod pro krycí signál vzorkovaný na frekvenci~44,1\,kHz.
