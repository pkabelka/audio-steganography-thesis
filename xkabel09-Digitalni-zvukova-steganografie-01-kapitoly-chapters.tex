...
použitím hodnoty 0,1 pro parametr \texttt{alpha}. Jako
...
a~použitím hodnoty 0,2 pro parametr \texttt{alpha}. Výhodou
...
metody~\cite{Kim2003} došli ke kapacitě 10\,bitů za sekundu při vzorkovací
frekvenci 44,1\,kHz.
