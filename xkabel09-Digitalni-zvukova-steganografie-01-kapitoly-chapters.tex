...
v~části~\ref{ssub:dataset-descriptions}. Podle~\cite{AlSabhany2020} patří mezi
používané sady také datový korpus \textit{TIMIT}~\cite{Garofolo1993}, avšak ten
zde nebude testován.
...
je hledání správných hodnot mnohem rychlejší než při hledání hrubou silo, ale
...
parametry. Z~výsledků v~prvním grafu byly vybrány nejlepší parametry metod,
které byly použity pro vytvoření grafů s~výsledky průměrných hodnot BER, SNR
a~PSNR.
