...
Implementovaná ozvěnová metoda má čtyři varianty jejichž výsledky se každá
z~nich snaží vylepšit předchozí.
...
\subsubsection*{Varianta s~ozvěnami s~kladnou a~zápornou amplitudou vpřed a~vzad}
