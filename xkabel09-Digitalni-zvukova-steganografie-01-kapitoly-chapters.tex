...
vynásoben pseudonáhodnou sekvencí hodnot \textit{-1} a~\textit{1} $n$-krát. Tím
...
přidanému šumu a~překódování do ztrátového formátu \cite{Boney1996}.
...
pseudonáhodnou sekvenci čipů, která byla použita k~zakódování. Dekódování
probíhá výpočtem korelace mezi stego médiem a~pseudonáhodnou sekvencí. Pro
