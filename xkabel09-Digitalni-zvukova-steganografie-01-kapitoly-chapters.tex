...
a~\texttt{\_secret\_data}. Proměnná \texttt{\_source\_data} obsahuje
...
\begin{figure}[hbt]
    \pgfplotstableread[
        col sep=semicolon,
        ]{data/no-modifications-all-params-mean.csv}\noModAllParamsMean
    \centering
    \begin{tikzpicture}
        \begin{axis}[%
            wideybar,
            ...
            xlabel={},
            ylabel={},
            ytick={0, 10, 25, 50, 75, 100},
            ymajorgrids=true,
            grid style=dashed,
            xtick=data, % needed for xticklabels
            xticklabels from table={\noModAllParamsMean}{method},
            ...
            \addplot table[x expr=\coordindex, y=ber percent] {\noModAllParamsMean};
            \addplot table[x expr=\coordindex, y=snr db] {\noModAllParamsMean};
            \addplot table[x expr=\coordindex, y=psnr db] {\noModAllParamsMean};
    ...
    a~$\mathrm{PSNR}_\mathrm{dB}$ bez modifikací metod.}
    \label{pic:no-mod-all-params-mean}
\end{figure}
