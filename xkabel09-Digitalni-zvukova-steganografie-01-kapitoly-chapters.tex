...
\section{Metoda rozprostřeného spektra}
\label{sec:dsss}
...
a~hodnotu \textit{1} používá bez změny \cite{Kuznetsov2022}. Poté je každý bit vynásoben
pseudonáhodnou sekvencí hodnot \textit{-1} a~\textit{1} $n$-krát. Zvýšení počtu
kopií bitů zvýší robustnost a~zároveň sníží kapacitu této metody
...
Pro dekódování je nezbytné, aby příjemce znal pseudonáhodnou sekvencí, která
byla použita k~zakódování informací \cite{Djebbar2012}.
