...
Každá z~podkapitol které budou následovat, se zaměří na nějakou z~používaných
...
proces ukrývání zprávy do jiného typu média nám slouží k~ochraně před
neautorizovanými či neoprávněnými příjemci \cite{Dutta2020}. Médium do kterého
informace skrýváme nazýváme nosič a~může být různých typů, jako například
obrázky, audio, video. V~poslední době se začaly objevovat nové směry založené
...
\todo{použití steganografie}

\blindtext

\todo{co je to vodoznak}
