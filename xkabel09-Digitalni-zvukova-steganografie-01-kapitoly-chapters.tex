...
obrázku~\ref{pic:continuous-vs-discrete-signal}. Aby nedošlo ke ztrátě
...
\begin{figure}[hbt]
    ...
    \begin{subfigure}[b]{0.5\linewidth}
        ...
        \end{tikzpicture}
    \end{subfigure}
    \caption{Spojitý signál (vlevo) a~navzorkovaný signál (vpravo) vzorkovaný na
    frekvenci 16\,Hz}
    \label{pic:continuous-vs-discrete-signal}
\end{figure}

Kvantování je diskretizace hodnot, kterých mohou jednotlivé vzorky signálu
nabývat.
        ...
        \begin{tikzpicture}
            \begin{axis}[%
                ...
                \addplot+[ycomb,blue,thick,mark=*] coordinates{
                    (1,0.5) (2,1.5) (3,1.5) (4,1.5) (5,1.5) (6,1.5) (7,0.5)
                    (8,-0.5) (9,-0.5) (10,-1.5) (11,-1.5) (12,-1.5) (13,-1.5)
                    (14,-1.5) (15,-0.5) (16,-0.5)
                };
            \end{axis}
        \end{tikzpicture}
    \end{subfigure}%
    \begin{subfigure}[b]{0.5\linewidth}
        ...
        \begin{tikzpicture}
            \begin{axis}[%
                ...
                \addplot+[ycomb,blue,thick,mark=*] coordinates{
                    (1,1.5) (2,2.5) (3,3.5) (4,3.5) (5,3.5) (6,2.5) (7,1.5)
                    (8,0.5) (9,-1.5) (10,-2.5) (11,-3.5) (12,-3.5) (13,-3.5)
                    (14,-2.5) (15,-1.5) (16,-0.5)
                };
            \end{axis}
        \end{tikzpicture}
    \end{subfigure}
    \caption{Signál z~obrázku \ref{pic:continuous-vs-discrete-signal}
